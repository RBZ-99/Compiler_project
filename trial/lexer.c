...
void tokeniseSourceCode(FILE *f, tokenStreamHead* streamHead){
    ...
    tokenStream* prevnode = (tokenStream* )calloc(1,sizeof(tokenStream));
    ...
    while(fgets(buffer,sizeof(buffer),f) != NULL){
        ...
        while(lexeme != NULL){
            tokenStream* newnode = (tokenStream* )calloc(1,sizeof(tokenStream));
...
//Work left
//Store data in the node of tokenStream
*/
